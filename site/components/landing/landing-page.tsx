						...
						<div className="max-w-3xl">
							...
							<div className="grid grid-cols-1 md:grid-cols-[max-content_1fr] gap-x-10 gap-y-6 mb-8">
								{([
									...
									{ flag: "--prefill-chunk-size", arg: "<n>", desc: "Chunk size for long-prompt prefill.", meta: <>default: <InlineCode>auto</InlineCode> (640MB GPU attention budget) · use <InlineCode>auto:&lt;mb&gt;</InlineCode> to tune or <InlineCode>0</InlineCode>/<InlineCode>off</InlineCode> to disable</> },
