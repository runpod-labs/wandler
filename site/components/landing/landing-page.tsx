						...
						<div className="max-w-3xl">
							...
							<div className="grid grid-cols-1 md:grid-cols-[max-content_1fr] gap-x-10 gap-y-6 mb-8">
								{([
									...
									{ flag: "--decode-loop", arg: "<mode>", desc: "Wandler-owned decode loop.", meta: <>default: <InlineCode>auto</InlineCode> · use <InlineCode>off</InlineCode> to fall back to transformers.js <InlineCode>generate()</InlineCode></> },
